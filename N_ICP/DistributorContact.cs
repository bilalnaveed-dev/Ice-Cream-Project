...
namespace N_ICP
{
    public partial class DistributorContact : MainForm
    {
        ...
        private void DistributorContact_Load(object sender, EventArgs e)
        {
            try
            {
                con.Open();
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "INSERT into distributor_contact(d_id, d_cnic, d_phone, d_address) values('" + id_comboBox.Text + "', '" + cnic_txt.Text + "', '" + phone_txt.Text + "', '" + address_txt.Text + "')";
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "UPDATE distributor_contact set d_cnic = '" + cnic_txt.Text + "', d_phone = '" + phone_txt.Text + "', d_address = '" + address_txt.Text + "' WHERE d_id = '" + id_comboBox.Text + "'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
        ...
        private void delete_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "DELETE from distributor_contact WHERE d_id = '" + id_comboBox.Text + "'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
        ...
        private void show()
        {
            try
            {
                string select = "SELECT * from distributor_contact";
                SqlCommand cmd = new SqlCommand(select, con);
