...
namespace N_ICP
{
    public partial class DistributorPersonal : MainForm
    {
        public DistributorPersonal()
        {
            InitializeComponent();
        }
        ...
        string status = "Distributor";

        private void DistributorPersonal_Load(object sender, EventArgs e)
        {
            show();
            show_login();
        }
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "INSERT into distributor_personal(d_id, d_name) values('" + id_txt.Text + "', '" + name_txt.Text + "')";
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "UPDATE distributor_personal set d_name = '" + name_txt.Text + "' WHERE d_id = '" + id_txt.Text + "'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
        ...
        private void delete_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "DELETE from distributor_personal WHERE d_id = '" + id_txt.Text + "'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
        ...
        private void show()
        {
            try
            {
                string select = "SELECT * from distributor_personal";
