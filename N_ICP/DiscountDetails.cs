...
namespace N_ICP
{
    public partial class DiscountDetails : MainForm
    {
        ...
        private void show()
        {
            try
            {
                string select = "SELECT * from add_customer_order where discount > '" + discount + "'";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView.Rows.Count; i++)
            {
                ...
                e.Graphics.DrawString("Discount Details", new Font("Arial", 35, FontStyle.Bold), Brushes.Black, new Point(225, 75));
